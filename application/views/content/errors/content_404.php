                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="text-center mt-4">
                                    <img class="img-fluid p-4" src="<?php echo base_url() ?>assets/assets/img/illustrations/404-error-with-a-cute-animal.svg" alt="" />
                                    <p class="lead">Halaman yang anda tuju tidak ditemukan.</p>
                                    <a href="<?php echo base_url() ?>"><i class="fa fa-arrow-left mr-2"></i>Kembali Ke Beranda</a>
                                </div>
                            </div>
                        </div>
                    </div>
